...
def load_data(train_filepath, val_filepath):
    ...
    with open('algorithms/NN/saved_prep_obj/cat_imputer.pkl', 'wb') as file:
    ...
    # Save LabelEncoder to reuse later
    with open('algorithms/NN/saved_prep_obj/label_encoders.pkl', 'wb') as file:
    ...
    with open('algorithms/NN/saved_prep_obj/num_imputer.pkl', 'wb') as file:
        pickle.dump(imputer, file)
    ...
    # Save StandardScaler for later
    with open('algorithms/NN/saved_prep_obj/scaler.pkl', 'wb') as file:
